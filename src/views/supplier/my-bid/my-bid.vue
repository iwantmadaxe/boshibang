<template>
	<div class="zeco-my-bid">
		<section class="my-bid-list">
...
<style lang="scss">
	...
	// 修正列表项背景色和底部线
	.zeco-my-bid .my-bid-list{
		background-color: $color-white;
	}
	.zeco-my-bid ul{
		@include border-bottom($border-color);
	}
	.zeco-my-bid ul>li:not(:last-child){
		@include border-bottom($border-color);
	}
	.zeco-my-bid ul>li:last-child .box-section:before{
		border-bottom: 0;
	}

	.zeco-my-bid .box-section img{
		width: 80%;
	}
	.zeco-my-bid .zeco-box-option{
		font-size: 0.8rem;
		color: darken($color-grey, 20%);
	}
	.zeco-my-bid .zeco-box-option .option-left{
		margin-top: 2px;
	}
	.zeco-my-bid .option-left{
		float: left;
		width: 60%;
		text-align: left;
	}
	.zeco-my-bid .option-right{
		float: right;
		width: 40%;
		text-align: right;
	}
	.zeco-my-bid .option-left>div, 
	.zeco-my-bid .option-left b, 
	.zeco-my-bid .option-left .address-detail{
		float: left;
		margin-top: 1px;
	}
	.zeco-my-bid .option-left, 
	...
	.zeco-my-bid .icon-tag-bid{
		background-color: #fcc854;
		color: $bid-color;
	}
	.zeco-my-bid .icon-tag-recruit{
		background-color: #0266bb;
		color: $color-white;
	}
	.zeco-my-bid .option-addresses{
		max-width: 70%;
		padding-left: 5px;
	}
	.zeco-my-bid .address-detail{
		max-width: 90%;
	}
	.zeco-my-bid .option-money{
		padding: 3px;
		font-size: 0.9rem;
		color: $bid-color;
	}

	.zeco-my-bid .zeco-box-assistant{
		line-height: 1rem;
		vertical-align: sub;
	}
	.zeco-my-bid .zeco-box-assistant .option-left, 
	.zeco-my-bid .zeco-box-assistant .option-right{
		width: 50%;
	}
	.zeco-my-bid .zeco-box-assistant .option-left{
		margin-top: 1px;
	}
	.zeco-my-bid .assistant-time, 
	.zeco-my-bid .assistant-watch-number{
		font-size: 0.7rem;
	...
	.zeco-my-bid .assistant-watch-number .icon-watch{
		width: 11px;
		height: 8px;
		display: inline-block;
	...
	.zeco-my-bid .assistant-watch-number .watch-number{
		float: left;
		max-width: 70%; 
	}

	// 加载控件
	.zeco-my-bid .zeco-info-loading{
	    height: 50px;
	    line-height: 50px;
	    position: relative;
	}
	.zeco-my-bid .zeco-loading-cover{
	    position: absolute;
	    left: 50%;
	    margin-left: -44.67px;
	}
	.zeco-my-bid .zeco-loading-cover .loading-animation{
		float: left;
	    margin-top: 11px;
	}
	.zeco-my-bid .zeco-loading-cover .loading-name{
		margin-left: 10px;
		float: left;
	}	
</style>