...
<style lang="scss">
	...
	.zeco-watch-supplier .watch-developer-list{
		background-color: $color-white;
	}
	.zeco-watch-supplier ul>li .mint-cell{
		padding: 15px 0;
	}

	// 取消cell滑动边框
	.zeco-watch-supplier .mint-cell{
		&:after{
			border: 0;
		}
	}
	.zeco-watch-supplier .mint-cell .mint-cell-title{
		display: none;
	}
	.zeco-watch-supplier .mint-cell .mint-cell-value{
		width: 100%;
	}
	.zeco-watch-supplier .mint-cell-swipe-button{
		line-height: 95px;
	}

	// box-section中图片居中
	.zeco-watch-supplier .pic-avatar{
		position: relative;
		height: 65px;
		overflow: hidden;
	}
	.zeco-watch-supplier .pic-avatar img{
		position: absolute;
		width: 100%;
		top: 0;
		bottom: 0;
	...
	.zeco-watch-supplier .manage-base,
	.zeco-watch-supplier .manage-ability{
		margin-top: 5px;
		font-size: 0.9rem;
		color: darken($color-grey, 20%);
	}
	.zeco-watch-supplier .manage-base .manage-left{
		float: left;
		text-align: left;
		max-width: 95%;
	}
	.zeco-watch-supplier .box-section{
		width: 100%;
	}
	.zeco-watch-supplier .manage-base .base-title{
		color: #666;
	}
	.zeco-watch-supplier .manage-base .base-content{
		display: inline-block;
		vertical-align: middle;
		max-width: 65%;
		color: $bid-color;
	}
	.zeco-watch-supplier .box-content .box-head{
		line-height: 1.5;
	}

	// 加载控件
	.zeco-watch-supplier .zeco-info-loading{
	    height: 50px;
	    line-height: 50px;
	    position: relative;
	}
	.zeco-watch-supplier .zeco-loading-cover{
	    position: absolute;
	    left: 50%;
	    margin-left: -44.67px;
	}
	.zeco-watch-supplier .zeco-loading-cover .loading-animation{
		float: left;
	    margin-top: 11px;
	}
	.zeco-watch-supplier .zeco-loading-cover .loading-name{
		margin-left: 10px;
		float: left;
	}
</style>